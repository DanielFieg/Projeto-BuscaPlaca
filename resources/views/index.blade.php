                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            ...
                            <p class="p-large">O Sistema de Consulta Veicular Integrada busca não apenas fornecer informações, mas também oferecer tranquilidade aos consumidores, permitindo que eles façam escolhas informadas e seguras ao adquirir um veículo.</p>
                            <a class="btn-solid-lg page-scroll" href="sign-up.html">CONSULTAR PLACA</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <!-- Newsletter Form -->
                        <form id="contato" data-toggle="validator" data-focus="false">
                            <div class="form-group">
                                <input type="email" class="form-control-input" id="nemail" required>
                                <label class="label-control" for="nemail">Nome</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control-input" id="nemail" required>
                                <label class="label-control" for="nemail">Telefone</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control-input" id="nemail" required>
                            ...
                            <div class="form-group">
                                <textarea class="form-control-input" id="nemail" rows="5" required></textarea>
                                <label class="label-control" for="nemail">Mensagem</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
